...
static CFFGLPluginInfo PluginInfo(
	PluginFactory< Bloom >,// Create method
	"BL02",                      // Plugin unique ID of maximum length 4.
	"AA BLOOM",            // Plugin name
...
FFResult Bloom::InitGL( const FFGLViewportStruct* vp )
{
...
FFResult Bloom::ProcessOpenGL( ProcessOpenGLStruct* inputTextures )
{
